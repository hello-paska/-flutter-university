...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Weather', style: TextStyle(color: Colors.black87, fontFamily: "SuisseIntl")),
          centerTitle: true,
  ...
  return Column(
    ...
    children: <Widget>[
      ...
      Text(
        ...
        'accumsan odio.',
        style: TextStyle(color: Colors.black54, fontFamily: "SuisseIntl"),
      ),
    ],
  );
}
...
Row _footerRatings() {
  ...
  return Row(
    ...
    children: <Widget>[
      Text('Info with ua.sinoptik.ua', style: TextStyle(fontSize: 15.0)),
      stars,
    ],
  );
}